...
@section('content')
    <div class="min-h-screen bg-gray-50 py-8 px-4 sm:px-6 lg:px-8" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
        <div class="max-w-4xl mx-auto">
            ...
            {{-- الفورم --}}
            <form action="{{ route('admin.building-utilities.store') }}" method="POST" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div
                            class="border-2 border-dashed border-gray-300 rounded-xl p-4 text-center hover:border-blue-400 transition-colors duration-200">
                            <input type="file" name="owner_id_image[]" id="front_id_image" accept="image/*"
                        ...
                        <div
                            class="border-2 border-dashed border-gray-300 rounded-xl p-4 text-center hover:border-blue-400 transition-colors duration-200">
                            <input type="file" name="owner_id_image[]" id="back_id_image" accept="image/*" class="hidden"
                                required>
                ...
                <div class="flex justify-end pt-4">
                    <button type="submit"
                        class="px-6 py-3 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-2">
