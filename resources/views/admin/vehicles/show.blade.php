...
<div class="bg-gray-50 dark:bg-gray-900 min-h-screen">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 mb-8">
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Plate Number') }}</label>
    ...
    <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border">
        <p class="text-gray-900 dark:text-white font-medium">{{ $vehicle->model }}</p>
                    ...
                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('License Expiry Date') }}</label>
                        <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                            <p class="text-gray-900 dark:text-white font-medium">{{ $vehicle->license_expiry_date?->format('Y-m-d') ?? '-' }}</p>
                        </div>
                    </div>

                    <div class="space-y-2">
                        <label class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Insurance Expiry Date') }}</label>
                        <div class="p-3 bg-gray-50 dark:bg-gray-700 rounded-lg border">
                            <p class="text-gray-900 dark:text-white font-medium">{{ $vehicle->insurance_expiry_date?->format('Y-m-d') ?? '-' }}</p>
                        </div>
                    </div>
                ...
                @if($vehicle->photo)
                <div class="mt-8">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">{{ __('Vehicle Photo') }}</h3>
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Type') }}</th>
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Date') }}</th>
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Cost') }}</th>
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Notes') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                ...
                                <td class="py-3 px-4 text-gray-900 dark:text-white">{{ $expense->expense_date }}</td>
                                <td class="py-3 px-4 text-gray-900 dark:text-white font-semibold">{{ number_format($expense->amount, 2) }}</td>
                                <td class="py-3 px-4 text-gray-600 dark:text-gray-400">{{ $expense->description ?: '-' }}</td>
                            </tr>
                            @empty
                            <tr>
                ...
                <div class="md:hidden space-y-4">
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                        <div class="flex justify-between items-start mb-2">
                            ...
                            <span class="font-bold text-green-600 dark:text-green-400">{{ number_format($expense->amount, 2) }}</span>
                        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700">
            <div class="p-6">
                    ...
                    <table class="w-full">
                        <thead>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Type') }}</th>
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Date') }}</th>
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Fine') }}</th>
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Driver') }}</th>
                                <th class="text-right py-3 px-4 text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('Notes') }}</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr class="border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700/50">
                                <td class="py-3 px-4 text-gray-900 dark:text-white">{{ $violation->violation_type }}</td>
                                <td class="py-3 px-4 text-gray-900 dark:text-white">{{ $violation->date }}</td>
                                <td class="py-3 px-4 text-gray-900 dark:text-white font-semibold">{{ number_format($violation->cost, 2) }}</td>
                                <td class="py-3 px-4 text-gray-900 dark:text-white">{{ $violation->user->name ?? '-' }}</td>
                                <td class="py-3 px-4 text-gray-600 dark:text-gray-400">{{ $violation->notes ?: '-' }}</td>
                            </tr>
                            @empty
                            <tr>
                ...
                <div class="md:hidden space-y-4">
                    ...
                    <div class="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border border-gray-200 dark:border-gray-600">
                        <div class="flex justify-between items-start mb-2">
                            <h4 class="font-medium text-gray-900 dark:text-white">{{ $violation->violation_type }}</h4>
                            <span class="font-bold text-red-600 dark:text-red-400">{{ number_format($violation->cost, 2) }}</span>
                        </div>
