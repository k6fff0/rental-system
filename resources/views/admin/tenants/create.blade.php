    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-2 px-2 sm:px-4 lg:px-8 transition-colors duration-300"
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="text-center mb-4 px-2">
                <div
                    class="inline-flex items-center justify-center w-12 h-12 bg-gradient-to-r from-blue-100 to-indigo-100 dark:from-blue-900/50 dark:to-indigo-900/50 rounded-xl mb-3">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="space-y-2">
                            ...
                            <select name="family_type" id="family_type" required
                                ...
                                <option value="individual" {{ old('family_type') == 'individual' ? 'selected' : '' }}>
                                    {{ __('messages.individual') }}</option>
                                <option value="family" {{ old('family_type') == 'family' ? 'selected' : '' }}>
                                    {{ __('messages.family') }}</option>
                            </select>
                            @error('family_type')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="relative">
                                    <input type="file" name="id_front" id="id_front" class="hidden"
                                        accept="image/*" onchange="showFileName(this, 'front-file-name')">
                                    <label for="id_front" class="block w-full cursor-pointer">
                                        <div
                                            class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-3 text-center hover:border-blue-400 dark:hover:border-blue-500 transition-all duration-200 bg-gray-50 dark:bg-gray-700/30">
                                            <svg class="mx-auto h-6 w-6 text-gray-400 dark:text-gray-500 mb-1"
                                            ...
                                            <p id="front-file-name"
                                                class="text-xs text-blue-600 dark:text-blue-400 mt-1 hidden font-medium">
                                            </p>
                                        </div>
                                    </label>
                                </div>
            ...
            if (window.innerWidth <= 768) {
                ...
                if ('vibrate' in navigator) {
                    const interactiveElements = document.querySelectorAll(
                        'button, label[for], input[type="checkbox"]');
