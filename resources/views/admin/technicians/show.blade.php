...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-blue-900/20 dark:to-indigo-900/20 py-4 px-2 sm:px-4 lg:px-8 transition-all duration-500"
        ...
        <div class="bg-gradient-to-r from-purple-600 via-indigo-600 to-blue-600 dark:from-purple-700 dark:via-indigo-700 dark:to-blue-700 rounded-2xl p-6 sm:p-8 mb-6 text-white shadow-2xl mx-2 sm:mx-4 relative overflow-hidden">
            {{-- Background Pattern --}}
            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-6 relative z-10">
                <div class="w-full sm:w-auto">
                    <div class="flex items-center gap-4 mb-4">
                        <div class="w-16 h-16 sm:w-20 sm:h-20 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-white/30">
                        ...
                        <div>
                            <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold mb-2">{{ __('messages.technician_profile') }}</h1>
                            <p class="text-purple-100 dark:text-purple-200 opacity-90 text-base sm:text-lg">{{ __('messages.view_technician_details') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="text-purple-200 text-sm">{{ $technician->mainSpecialty->name ?? __('messages.no_specialty') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="max-w-7xl mx-auto px-2 sm:px-4">
            <div class="grid grid-cols-1 xl:grid-cols-4 gap-6">
                ...
                <div class="xl:col-span-3 space-y-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 border border-gray-200 dark:border-gray-700">
                        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/30 dark:to-indigo-900/30 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                {{-- Name Field --}}
                                <div class="group">
                                    <label class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2 block">{{ __('messages.full_name') }}</label>
                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 border border-gray-200 dark:border-gray-600 group-hover:border-blue-300 dark:group-hover:border-blue-500 transition-all duration-200">
                                        <div class="text-lg font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
                                ...
                                {{-- Email Field --}}
                                <div class="group">
                                    <label class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2 block">{{ __('messages.email') }}</label>
                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 border border-gray-200 dark:border-gray-600 group-hover:border-green-300 dark:group-hover:border-green-500 transition-all duration-200">
                                ...
                                {{-- Phone Field --}}
                                <div class="group">
                                    <label class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2 block">{{ __('messages.phone') }}</label>
                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 border border-gray-200 dark:border-gray-600 group-hover:border-purple-300 dark:group-hover:border-purple-500 transition-all duration-200">
                                ...
                                <div class="group">
                                    <label class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-2 block">{{ __('messages.main_specialty') }}</label>
                                    <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 border border-gray-200 dark:border-gray-600 group-hover:border-indigo-300 dark:group-hover:border-indigo-500 transition-all duration-200">
                                        <div class="text-lg text-gray-900 dark:text-gray-100 flex items-center gap-2">
                            ...
                            <div class="mt-6">
                                <label class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3 block">{{ __('messages.additional_tasks') }}</label>
                                @php
                                ...
                                @if ($subTasks && $subTasks->isNotEmpty())
                                    <div class="flex flex-wrap gap-3">
                                        @foreach ($subTasks as $task)
                                            <span class="inline-flex items-center px-4 py-2 rounded-xl text-sm font-semibold bg-gradient-to-r from-purple-100 to-indigo-100 dark:from-purple-900/30 dark:to-indigo-900/30 text-purple-800 dark:text-purple-300 border border-purple-200 dark:border-purple-700 shadow-sm">
                            ...
                            @if ($technician->notes)
                                <div class="mt-6">
                                    <label class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide mb-3 block">{{ __('messages.notes') }}</label>
                                    <div class="bg-amber-50 dark:bg-amber-900/20 rounded-xl p-4 border border-amber-200 dark:border-amber-700/50">
                                        <div class="text-gray-900 dark:text-gray-100 whitespace-pre-wrap text-sm leading-relaxed">
                                            {{ $technician->notes }}
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 border border-gray-200 dark:border-gray-700">
                        <div class="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/30 dark:to-red-900/30 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                        ...
                        <div class="p-6">
                            <div class="space-y-4 max-h-96 overflow-y-auto">
                                @forelse ($requests->sortByDesc('updated_at') as $req)
                                    ...
                                    <div class="flex items-start gap-4 p-4 rounded-xl {{ $bgColor }} border {{ $borderColor }} shadow-sm hover:shadow-md transition-all duration-200">
                                        <div class="flex-shrink-0 flex items-center justify-center w-8 h-8 {{ $color }} rounded-lg text-white">
                                            {!! $icon !!}
                                        </div>
                                ...
                                @empty
                                    <div class="p-8 text-center">
                                        ...
                                        <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('messages.no_activity_found') }}</p>
                                    </div>
                                @endforelse
                            </div>
                        </div>
                ...
                <div class="xl:col-span-1 space-y-6">
                    ...
                    {{-- Status Card --}}
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 border border-gray-200 dark:border-gray-700">
                        <div class="bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                            <h3 class="text-lg font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                                <div class="w-6 h-6 bg-indigo-100 dark:bg-indigo-900/50 rounded-lg flex items-center justify-center">
                        ...
                        <div class="p-6">
                            ...
                            <div class="text-center mb-4">
                                <div class="inline-flex items-center gap-3 px-6 py-3 rounded-2xl {{ $config['bg'] }} {{ $config['text'] }} border-2 {{ $config['border'] }} {{ $config['pulse'] }}">
                                    <div class="flex items-center justify-center">
                                        {!! $config['icon'] !!}
                                    </div>
                                    <span class="font-bold text-sm">{{ __('messages.technician_status_' . $status) }}</span>
                                </div>
                            </div>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-700 rounded-xl p-4 border border-gray-200 dark:border-gray-600">
                                <div class="text-center">
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mb-2 uppercase tracking-wide font-semibold">{{ __('messages.status_description') }}</div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 border border-gray-200 dark:border-gray-700">
                        <div class="bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/30 dark:to-red-900/30 px-6 py-4 border-b border-gray-200 dark:border-gray-600">
                            <h3 class="text-lg font-bold text-gray-800 dark:text-gray-200 flex items-center gap-2">
                                <div class="w-6 h-6 bg-orange-100 dark:bg-orange-900/50 rounded-lg flex items-center justify-center">
                        ...
                        <div class="p-6 space-y-3">
                            ...
                            <a href="{{ route('admin.technicians.edit', $technician->id) }}"
                                ...
                                <svg class="w-5 h-5 {{ app()->getLocale() === 'ar' ? 'ml-2' : 'mr-2' }} group-hover:rotate-12 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden transition-all duration-300 border border-gray-200 dark:border-gray-700">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                {{-- Total Tasks --}}
                                <div class="flex justify-between items-center p-3 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-200 dark:border-blue-700">
                                    <span class="text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2">
                                        <div class="w-3 h-3 bg-blue-500 rounded-full"></div>
                                        {{ __('messages.total_tasks') }}
                                    </span>
                                    <span class="font-bold text-blue-600 dark:text-blue-400 text-lg">{{ $total }}</span>
                                </div>

                                {{-- Completed Tasks --}}
                                <div class="flex justify-between items-center p-3 bg-green-50 dark:bg-green-900/20 rounded-xl border border-green-200 dark:border-green-700">
                                    <span class="text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2">
                                        <div class="w-3 h-3 bg-green-500 rounded-full"></div>
                                        {{ __('messages.completed_tasks') }}
                                    </span>
                                    <span class="font-bold text-green-600 dark:text-green-400 text-lg">{{ $completed }}</span>
                                </div>

                                {{-- In Progress Tasks --}}
                                <div class="flex justify-between items-center p-3 bg-yellow-50 dark:bg-yellow-900/20 rounded-xl border border-yellow-200 dark:border-yellow-700">
                                    <span class="text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2">
                                        <div class="w-3 h-3 bg-yellow-500 rounded-full"></div>
                                        {{ __('messages.in_progress_tasks') }}
                                    </span>
                                    <span class="font-bold text-yellow-600 dark:text-yellow-400 text-lg">{{ $in_progress }}</span>
                                </div>

                                {{-- New Tasks --}}
                                <div class="flex justify-between items-center p-3 bg-indigo-50 dark:bg-indigo-900/20 rounded-xl border border-indigo-200 dark:border-indigo-700">
                                    <span class="text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2">
                                        <div class="w-3 h-3 bg-indigo-500 rounded-full"></div>
                                        {{ __('messages.new_tasks') }}
                                    </span>
                                    <span class="font-bold text-indigo-600 dark:text-indigo-400 text-lg">{{ $new }}</span>
                                </div>

                                {{-- Rejected Tasks --}}
                                <div class="flex justify-between items-center p-3 bg-red-50 dark:bg-red-900/20 rounded-xl border border-red-200 dark:border-red-700">
                                    <span class="text-sm text-gray-600 dark:text-gray-400 flex items-center gap-2">
                                        <div class="w-3 h-3 bg-red-500 rounded-full"></div>
                                        {{ __('messages.rejected_tasks') }}
                                    </span>
                                    <span class="font-bold text-red-600 dark:text-red-400 text-lg">{{ $rejected }}</span>
                                </div>

                                {{-- Success Rate --}}
                                <div class="pt-4 border-t-2 border-gray-200 dark:border-gray-600">
                                    <div class="flex justify-between items-center p-4 bg-gradient-to-r from-purple-50 to-pink-50 dark:from-purple-900/20 dark:to-pink-900/20 rounded-xl border border-purple-200 dark:border-purple-700">
