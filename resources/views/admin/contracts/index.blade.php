    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-6">
        <div class="max-w-full px-4 sm:px-6 lg:px-8" dir="{{ app()->getLocale() === 'ar' ? 'rtl' : 'ltr' }}">
            ...
            <div class="mb-6 space-y-4">
                ...
                <div class="{{ app()->getLocale() === 'ar' ? 'text-right' : 'text-left' }}">
                    <h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100 flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 me-3 text-blue-500 dark:text-blue-400"
                    ...
                    <p class="text-base text-gray-500 dark:text-gray-400 mt-2">{{ __('messages.contracts_description') }}
                    </p>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div
                        class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                    {{ __('messages.total_contracts') }}</p>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                    {{ __('messages.active_contracts') }}</p>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="bg-yellow-100 dark:bg-yellow-900 p-4 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-yellow-600 dark:text-yellow-400"
                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                    {{ __('messages.expired_contracts') }}</p>
                                <p class="text-3xl font-bold text-red-600 dark:text-red-400 mt-1">{{ $expiredCount ?? 0 }}
                                </p>
                            </div>
                    ...
                    <form method="GET" action="{{ route('admin.contracts.index') }}" id="filterForm">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-4">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    class="absolute inset-y-0 {{ app()->getLocale() === '' ? 'end-0 pe-3' : 'start-0 ps-3' }} flex items-center pointer-events-none mt-7">
                            ...
                            <div>
                                ...
                                <select name="status"
                                    ...
                                    <option value="expiring" {{ request('status') == 'expiring' ? 'selected' : '' }}>
                                        {{ __('messages.expiring_soon') }}</option>
            ...
            @if ($contracts->isEmpty())
                <div
                    class="bg-white dark:bg-gray-800 p-12 rounded-xl shadow-sm text-center text-gray-500 dark:text-gray-400 border border-gray-200 dark:border-gray-700">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        class="h-20 w-20 mx-auto text-gray-300 dark:text-gray-600 mb-6" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
            ...
            @else
                <div
                    ...
                    <div
                        class="px-6 py-4 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 border-b border-gray-200 dark:border-gray-700">
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full">
                            <thead class="bg-gray-50 dark:bg-gray-900/50">
                                <tr>
                                    <th
                                        class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider text-{{ app()->getLocale() === 'ar' ? 'right' : 'left' }}">
                                        #
                                    </th>
                                    <th
                                        class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider text-{{ app()->getLocale() === 'ar' ? 'right' : 'left' }}">
                                    ...
                                    <th
                                        class="px-6 py-4 text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wider text-center">
                                        {{ __('messages.actions') }}
                                    </th>
                                </tr>
                            </thead>
                                ...
                                @foreach ($contracts as $index => $contract)
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-all duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                class="text-sm font-bold text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors cursor-pointer">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-12 w-12">
                                                    <div
                                                        class="h-12 w-12 rounded-full bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-600 dark:to-gray-700 flex items-center justify-center shadow-inner">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex flex-col items-start">
                                                <span
                                                    class="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-900/30 dark:to-blue-800/30 text-blue-700 dark:text-blue-300 rounded-lg text-xs font-bold shadow-sm">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-3.5 w-3.5 {{ app()->getLocale() === 'ar' ? 'ml-1.5' : 'mr-1.5' }}"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex flex-col space-y-1">
                                                <div class="flex items-center text-sm">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-4 w-4 text-gray-400 {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }}"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                    ...
                                                    <span
                                                        class="font-medium text-gray-700 dark:text-gray-300">{{ $contract->start_date->format('Y-m-d') }}</span>
                                                </div>
                                                <div class="flex items-center text-sm">
                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                        class="h-4 w-4 {{ $status === 'expired' ? 'text-red-500' : ($status === 'expiring' ? 'text-yellow-500' : 'text-green-500') }} {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }}"
                                                        fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                                            stroke-width="2"
                                                            d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                                    ...
                                                    <span
                                                        class="font-medium {{ $status === 'expired' ? 'text-red-600 dark:text-red-400' : ($status === 'expiring' ? 'text-yellow-600 dark:text-yellow-400' : 'text-green-600 dark:text-green-400') }}">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span
                                                ...
                                                {{ match ($status) {
                                                    ...
                                                    'expiring'
                                                        => 'bg-yellow-100 dark:bg-yellow-900/30 text-yellow-700 dark:text-yellow-300 ring-1 ring-yellow-200 dark:ring-yellow-800',
                                                    'terminated'
                                                        => 'bg-gray-100 dark:bg-gray-700/30 text-gray-700 dark:text-gray-300 ring-1 ring-gray-200 dark:ring-gray-600',
                                                    default
                                                        => 'bg-green-100 dark:bg-green-900/30 text-green-700 dark:text-green-300 ring-1 ring-green-200 dark:ring-green-800',
                                                } }}">
                                                <span
                                                    class="relative flex h-2 w-2 {{ app()->getLocale() === 'ar' ? 'ml-1.5' : 'mr-1.5' }}">
                                                    <span
                    ...
                    @if ($contracts->hasPages())
                        <div
                            class="bg-gray-50 dark:bg-gray-900/50 px-6 py-4 border-t border-gray-200 dark:border-gray-700">
                            <div class="flex flex-col lg:flex-row items-center justify-between gap-4">
                                <div class="text-sm text-gray-700 dark:text-gray-300">
                                    {{ __('messages.showing') }}
                                    <span
                                        class="font-bold text-gray-900 dark:text-gray-100">{{ $contracts->firstItem() }}</span>
                                    {{ __('messages.to') }}
                                    <span
                                        class="font-bold text-gray-900 dark:text-gray-100">{{ $contracts->lastItem() }}</span>
                                    {{ __('messages.of') }}
                                    <span
                                        class="font-bold text-gray-900 dark:text-gray-100">{{ $contracts->total() }}</span>
                                    {{ __('messages.results') }}
                                </div>
                                ...
                                <nav
                                        ...
                                        <span
                                            ...
                                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                ...
                                                <path fill-rule="evenodd"
                                                    d="{{ app()->getLocale() === 'ar' ? 'M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z' : 'M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z' }}"
                                                    clip-rule="evenodd" />
                                            </svg>
                                        </span>
                                    @else
                                    ...
                                    @for ($i = $start; $i <= $end; $i++)
                                        @if ($i == $currentPage)
                                            <span
                                                class="px-4 py-2 text-sm font-bold text-white bg-blue-600 dark:bg-blue-500 rounded-lg shadow-md">
                                                {{ $i }}
                                            </span>
                                        @else
                                    ...
                                    @if ($contracts->hasMorePages())
                                        <a href="{{ $contracts->nextPageUrl() }}"
                                            ...
                                            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                                fill="currentColor">
                                                <path fill-rule="evenodd"
                                                    d="{{ app()->getLocale() === 'ar' ? 'M12.707 5.293a1 1 0 010 1.414L9.414 10l3.293 3.293a1 1 0 01-1.414 1.414l-4-4a1 1 0 010-1.414l4-4a1 1 0 011.414 0z' : 'M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z' }}"
                                                    clip-rule="evenodd" />
                                            </svg>
                                        </a>
                                    @else
