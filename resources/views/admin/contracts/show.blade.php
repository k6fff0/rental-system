                ...
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div>
                        ...
                        <p class="text-base text-gray-500 dark:text-gray-400 mt-2">
                            {{ __('messages.contract_number') }}: <span
                                class="font-bold text-blue-600 dark:text-blue-400">{{ $contract->contract_number }}</span>
                        </p>
                    </div>
                    <a href="{{ route('admin.contracts.index') }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg"
                            class="h-5 w-5 {{ app()->getLocale() === 'ar' ? 'rotate-180' : '' }}" fill="none"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <div
                            class="p-3 rounded-full {{ match ($status) {
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-sm font-medium text-gray-500 dark:text-gray-400">
                                {{ __('messages.contract_duration') }}</p>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="p-3 rounded-full bg-emerald-100 dark:bg-emerald-900">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8 text-emerald-600 dark:text-emerald-400"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p>
                                {{ $days < 0 ? __('messages.expired') : __('messages.remaining_in', ['days' => $days]) }}
                            </p>
                ...
                <div class="lg:col-span-2 space-y-6">
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 me-2 text-blue-500 dark:text-blue-400"
                                fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.tenant_name') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->tenant->name ?? '-' }}</p>
                            </div>
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.phone') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->tenant->phone ?? '-' }}</p>
                            </div>
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.tenant_email') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->tenant->email ?? '-' }}</p>
                            </div>
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.national_id') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->tenant->id_number ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 me-2 text-indigo-500 dark:text-indigo-400" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.unit_number') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->unit->unit_number ?? '-' }}</p>
                            </div>
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.building') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->unit->building->name ?? '-' }}</p>
                            </div>
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.floor') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->unit->floor ?? '-' }}</p>
                            </div>
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.unit_type') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->unit->unit_type ?? '-' }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 me-2 text-emerald-500 dark:text-emerald-400" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.start_date') }}</label>
                                <p class="text-base font-semibold text-gray-800 dark:text-gray-100 mt-1">
                                    {{ $contract->start_date->format('Y-m-d') }}</p>
                            </div>
                            <div>
                                <label
                                    class="text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('messages.end_date') }}</label>
                                <p
                                    class="text-base font-semibold {{ $contract->end_date->isPast() ? 'text-red-600 dark:text-red-400' : 'text-gray-800 dark:text-gray-100' }} mt-1">
                    ...
                    @if ($contract->notes)
                        <div
                            ...
                            <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-6 w-6 me-2 text-yellow-500 dark:text-yellow-400" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <div class="space-y-6">
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4">
                            {{ __('messages.contract_actions') }}</h3>
                        <div class="space-y-3">
                            {{-- طباعة العقد --}}
                    ...
                    <div
                        ...
                        <div class="flex justify-between items-center mb-4">
                            <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg"
                                    class="h-6 w-6 me-2 text-blue-500 dark:text-blue-400" fill="none"
                                    viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        @if ($contract->contract_image)
                            <div class="mb-4">
                                <a data-fancybox="contract" href="{{ asset('storage/' . $contract->contract_image) }}">
                                    <img src="{{ asset('storage/' . $contract->contract_image) }}" alt="Contract Image"
                                ...
                                @foreach ($contract->attachments ?? [] as $attachment)
                                    <div
                                        ...
                                        <div class="flex items-center gap-3">
                                            ...
                                            @endphp
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                class="h-6 w-6 text-gray-500 dark:text-gray-300" fill="none"
                                                viewBox="0 0 24 24" stroke="currentColor">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                    d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                                            </svg>
                                            <div>
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                    {{ $attachment->created_at->format('Y-m-d') }}</p>
                                            </div>
                                        </div>
                                        <div class="flex items-center gap-2">
                                            ...
                                            @can('delete contract attachments')
                                                <form
                                                    action="{{ route('admin.contracts.attachments.destroy', [$contract->id, $attachment->id]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                                        onclick="return confirm('{{ __('messages.confirm_delete_attachment') }}')"
                    ...
                    <div
                        ...
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4 flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg"
                                class="h-6 w-6 me-2 text-green-500 dark:text-green-400" fill="none"
                                viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                        ...
                        @if ($contract->payments->isEmpty())
                            <div class="text-center py-4">
                                ...
                                <p class="mt-2 text-gray-500 dark:text-gray-400">{{ __('messages.no_payments_found') }}
                                </p>
                            </div>
                        @else
                            <div class="space-y-4">
    ...
    <div id="attachmentModal" class="hidden fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full">
        <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white dark:bg-gray-800">
            <div class="flex justify-between items-center mb-4">
                ...
                <button onclick="document.getElementById('attachmentModal').classList.add('hidden')"
            ...
            @if (Route::has('admin.contracts.attachments.store') && isset($contract))
                <form action="{{ route('admin.contracts.attachments.store', $contract->id) }}" method="POST"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="mb-4">
                        <label for="attachment_name"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('messages.attachment_name') }}</label>
                        <input type="text" name="name" id="attachment_name" required
                            class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white">
                    </div>
                    <div class="mb-4">
                        <label for="attachment_file"
                            class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">{{ __('messages.file') }}</label>
                        <input type="file" name="file" id="attachment_file" required
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">{{ __('messages.allowed_file_types') }}
                        </p>
                    </div>
                    <div class="flex justify-end gap-3 mt-6">
                        <button type="button"
                            onclick="document.getElementById('attachmentModal').classList.add('hidden')"
                            class="px-4 py-2 text-sm bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-md">
                            {{ __('messages.cancel') }}
                        </button>
                        <button type="submit"
