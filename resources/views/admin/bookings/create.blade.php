...
@section('content')
    <div
        class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-6 px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl mx-auto">
            {{-- Card Container --}}
            <div
                class="bg-white dark:bg-gray-800 rounded-xl shadow-xl overflow-hidden ring-1 ring-gray-200 dark:ring-gray-700 transition-all duration-300 hover:shadow-2xl">
                {{-- Card Header --}}
