    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 mb-8">
            <div class="flex flex-wrap items-center gap-4">
                ...
                <button class="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-3 rounded-xl transition-all duration-300 flex items-center gap-2">
                    <i class="fas fa-search"></i>
                    بحث
                </button>
                <button class="bg-gray-200 dark:bg-gray-600 hover:bg-gray-300 dark:hover:bg-gray-500 text-gray-700 dark:text-gray-200 px-6 py-3 rounded-xl transition-all duration-300 flex items-center gap-2">
                ...
                <table class="min-w-full">
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-700">
                        @forelse($complaints as $index => $complaint)
                            <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 dark:hover:from-gray-700 dark:hover:to-gray-600 transition-all duration-300 cursor-pointer">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex space-x-2 rtl:space-x-reverse">
                                        ...
                                        <button class="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-xs transition-all duration-300 flex items-center gap-1">
...
<div id="complaintModal" class="fixed inset-0 z-50 hidden overflow-y-auto">
    <div class="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <!-- Modal content -->
        <div class="inline-block w-full max-w-2xl p-6 my-8 overflow-hidden text-right transition-all transform bg-white dark:bg-gray-800 shadow-2xl rounded-2xl align-middle">
            <!-- Modal Header -->
            <div class="flex items-center justify-between pb-4 border-b border-gray-200 dark:border-gray-600">
                ...
                <button onclick="closeComplaintModal()" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
            ...
            <div class="mt-6 space-y-6">
                <!-- Customer Info -->
                <div class="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 p-6 rounded-xl">
                ...
                <!-- Complaint Details -->
                <div class="bg-gradient-to-r from-yellow-50 to-orange-50 dark:from-gray-700 dark:to-gray-600 p-6 rounded-xl">
                    <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-4 flex items-center">
                ...
                <!-- Date Info -->
                <div class="bg-gradient-to-r from-green-50 to-emerald-50 dark:from-gray-700 dark:to-gray-600 p-6 rounded-xl">
                    <h4 class="text-lg font-semibold text-gray-800 dark:text-white mb-4 flex items-center">
            ...
            <div class="flex justify-between items-center mt-8 pt-6 border-t border-gray-200 dark:border-gray-600">
                <div class="flex space-x-3 rtl:space-x-reverse">
                    <button class="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-xl transition-all duration-300 flex items-center gap-2">
                        <i class="fas fa-reply"></i>
                        الرد على الشكوى
                    </button>
                    <button class="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-xl transition-all duration-300 flex items-center gap-2">
                        <i class="fas fa-print"></i>
                        طباعة
                    </button>
                </div>
                <button onclick="closeComplaintModal()" class="bg-gray-500 hover:bg-gray-600 text-white px-6 py-3 rounded-xl transition-all duration-300">
                    إغلاق
                </button>
            </div>
        </div>
