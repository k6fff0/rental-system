    ...
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
            ...
            @if ($expiringContracts->count() > 0)
                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
                    <div class="flex items-center">
                        ...
                        <span
                            class="font-medium">{{ __('messages.expiring_contracts_alert', ['count' => $expiringContracts->count()]) }}</span>
                    </div>
                </div>
            @endif
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white shadow rounded-lg p-6 border-l-4 border-blue-500 hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-blue-200" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-white shadow rounded-lg p-6 border-l-4 border-green-500 hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-green-200" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.buildings.index') }}"
                    class="mt-4 inline-flex items-center text-sm font-medium text-green-600 hover:text-green-800">
                    {{ __('messages.view_all') }}
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
            ...
            <div class="bg-white shadow rounded-lg p-6 border-l-4 border-purple-500 hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-purple-200" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <div class="bg-white shadow rounded-lg p-6 border-l-4 border-yellow-500 hover:shadow-md transition-shadow">
                <div class="flex justify-between items-start">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-10 w-10 text-yellow-200" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('admin.tenants.index') }}"
                    class="mt-4 inline-flex items-center text-sm font-medium text-yellow-600 hover:text-yellow-800">
                    {{ __('messages.view_all') }}
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 ml-1" fill="none" viewBox="0 0 24 24"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                        ...
                        @foreach ($expiringContracts as $contract)
                            <li class="border-b pb-2">
                                <a href="{{ route('admin.contracts.edit', $contract->id) }}"
                                    class="flex justify-between items-center hover:bg-gray-50 p-2 rounded">
                                    <div>
                                        <p class="font-medium">{{ $contract->tenant->name }}</p>
                                        <p class="text-sm text-gray-500">{{ $contract->unit->unit_number }} -
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-white shadow rounded-lg p-6 border-l-4 border-red-500">
                ...
                <p class="text-3xl font-bold mt-2 text-red-600">{{ number_format($totalExpenses, 2) }}
                    {{ __('messages.currency') }}</p>
                <p class="text-sm text-gray-500 mt-2">{{ __('messages.total_expenses_description') }}</p>
                <a href="{{ route('admin.expenses.index') }}"
                    class="mt-4 inline-flex items-center text-sm font-medium text-red-600 hover:text-red-800">
            ...
            <div class="bg-white shadow rounded-lg p-6 border-l-4 border-green-500">
                ...
                <p class="text-3xl font-bold mt-2 text-green-600">{{ number_format($totalIncome, 2) }}
                    {{ __('messages.currency') }}</p>
