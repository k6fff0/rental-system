            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 fade-in">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                    @foreach($buildings as $building)
                        ...
                        <div class="building-card {{ $isLocked ? 'locked' : ($isAssigned ? 'assigned' : '') }} 
                            ...
                            <label class="flex items-center space-x-3 rtl:space-x-reverse cursor-pointer">
                                <input type="checkbox"
                                       ...
                                       {{ $isAssigned ? 'checked' : '' }}
                                       {{ $isLocked ? 'disabled' : '' }}
                                       class="checkbox-custom building-checkbox"
                                       onchange="updateCounter()">
                                
                                <div class="flex-1">
                                    <div class="flex items-center justify-between">
                                        <h3 class="font-semibold text-gray-900 {{ $isLocked ? 'line-through text-gray-500' : '' }}">
                                            {{ $building->name }}
                                        </h3>
