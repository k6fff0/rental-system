        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="mb-6">
                <div class="flex items-center gap-4 flex-col sm:flex-row">
                    <a href="{{ URL::previous() }}"
                        class="inline-flex items-center text-sm text-gray-600 hover:text-gray-900 w-full sm:w-auto">
                        <svg class="w-5 h-5 rtl:ml-2 ltr:mr-2 transform rtl:rotate-180" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <div class="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                            @can('view payment logs')
                                <a href="{{ route('admin.payments.logs.all') }}"
                                    ...
                                    <svg class="rtl:ml-2 ltr:mr-2 h-5 w-5 text-gray-500" xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20" fill="currentColor">
                                        <path fill-rule="evenodd"
                            ...
                            <a href="{{ route('admin.payments.create') }}"
                                ...
                                <svg class="rtl:ml-2 ltr:mr-2 h-5 w-5" xmlns="http://www.w3.org/2000/svg"
                                    viewBox="0 0 20 20" fill="currentColor">
                                    <path fill-rule="evenodd"
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                <th scope="col"
                                    class="px-4 sm:px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider">
                                    {{ __('messages.tenant') }}
                                </th>
                                <th scope="col"
                                    class="px-4 sm:px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider hidden sm:table-cell">
                                    {{ __('messages.contract_code') }}
                                </th>
                                <th scope="col"
                                    class="px-4 sm:px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider hidden md:table-cell">
                                    {{ __('messages.building') }}
                                </th>
                                <th scope="col"
                                    class="px-4 sm:px-6 py-3 text-start text-xs font-medium text-gray-500 uppercase tracking-wider hidden lg:table-cell">
                                    {{ __('messages.unit') }}
                                </th>
                                <th scope="col"
                                    class="px-4 sm:px-6 py-3 text-end text-xs font-medium text-gray-500 uppercase tracking-wider">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @forelse ($data as $row)
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td
                                        class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500 hidden sm:table-cell">
                                        {{ $row['contract_code'] }}
                                    </td>
                                    <td
                                        class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500 hidden md:table-cell">
                                        {{ $row['building'] }}
                                    </td>
                                    <td
                                        class="px-4 sm:px-6 py-4 whitespace-nowrap text-sm text-gray-500 hidden lg:table-cell">
                                        {{ $row['unit'] }}
                                    </td>
