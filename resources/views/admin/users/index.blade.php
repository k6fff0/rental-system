                        ...
                        <div class="flex flex-col sm:flex-row gap-3">
                            ...
                            <div class="relative rounded-lg shadow-sm">
                                ...
                                <input type="text" name="search" id="search"
                                    class="focus:ring-blue-500 focus:border-blue-500 block w-full {{ app()->getLocale() === 'ar' ? 'pr-10' : 'pl-10' }} sm:text-sm border-gray-300 rounded-lg h-10"
                            ...
                            <div class="relative">
                                <button type="button"
                                    class="inline-flex justify-center w-full rounded-lg border border-gray-300 shadow-sm px-4 py-2 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 h-10"
                                    id="filter-menu" aria-expanded="false" aria-haspopup="true">
                                    <svg class="-mr-1 ml-1 h-5 w-5 {{ app()->getLocale() === 'ar' ? 'mr-1 ml-1' : 'ml-1 mr-1' }}"
                ...
                rounded-full border-2 border-white transition-all duration-300"
                                            ...
                                            <div class="flex-1 min-w-0">
                                                <div
                                                    ...
                                                    <p class="text-sm font-medium text-gray-900 hover:text-blue-600 transition-colors duration-200 truncate"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex-1 flex justify-between sm:hidden">
                                @if ($users->onFirstPage())
                                    <span
                                        class="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-500 bg-white cursor-default">
                                ...
                                @else
                                    <span
                                        class="ml-3 relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm font-medium rounded-lg text-gray-500 bg-white cursor-default">
                                        {{ __('messages.next') }}
                                    </span>
                                @endif
                            </div>
