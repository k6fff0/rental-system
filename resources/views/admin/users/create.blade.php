        ...
        <form action="{{ route('admin.users.store') }}" method="POST" class="bg-white shadow rounded-lg p-6">
            ...
            <div class="mb-4">
                <label for="password_confirmation"
                    class="block text-sm font-medium text-gray-700">{{ __('messages.password_confirmation') }}</label>
            ...
            <div class="mb-4">
                <label for="role"
                    class="block text-sm font-medium text-gray-700">{{ __('messages.select_role') }}</label>
            ...
            <form method="POST" enctype="multipart/form-data" ...>
                <div class="mb-4">
                    <label for="photo"
                        class="block text-sm font-medium text-gray-700">{{ __('messages.user_photo') }}</label>
