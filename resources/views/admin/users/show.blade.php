...
@section('content')
        ...
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
            ...
            <div class="mb-6 sm:mb-8">
                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    <div>
                        <h1 class="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-gray-100 transition-colors duration-300">
            ...
            <!-- Main Profile Card -->
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300 mb-6">
                <!-- Profile Header -->
                <div class="bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-700 dark:to-indigo-800 px-6 sm:px-8 py-8 sm:py-12">
                    <div class="flex flex-col lg:flex-row items-center lg:items-start gap-6">
                        <!-- User Avatar -->
                        <div class="relative">
                            <div class="w-24 h-24 sm:w-32 sm:h-32 rounded-full overflow-hidden ring-4 ring-white/20 backdrop-blur-sm">
                                @if ($user->photo_url)
                                ...
                                @else
                                    <div class="w-full h-full bg-gradient-to-br from-white/20 to-white/10 flex items-center justify-center backdrop-blur-sm">
                            ...
                            <div class="absolute -bottom-2 {{ app()->getLocale() === 'ar' ? '-left-2' : '-right-2' }} 
                                ...
                                <div class="w-2 h-2 rounded-full bg-white {{ app()->getLocale() === 'ar' ? 'ml-1.5' : 'mr-1.5' }} animate-pulse"></div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 flex items-center">
                            <svg class="w-5 h-5 {{ app()->getLocale() === 'ar' ? 'ml-2' : 'mr-2' }} text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @if($user->roles->count() > 0)
                            <div class="space-y-3">
                                @foreach($user->roles as $role)
                                    ...
                                    @endphp
                                    <div class="flex items-center justify-between p-3 rounded-lg border {{ $roleColor }} transition-all duration-200 hover:shadow-md">
                                        <div class="flex items-center">
                                            <div class="w-8 h-8 rounded-lg bg-current opacity-20 flex items-center justify-center {{ app()->getLocale() === 'ar' ? 'ml-3' : 'mr-3' }}">
                                                <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
                                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-6-3a2 2 0 11-4 0 2 2 0 014 0zm-2 4a5 5 0 00-4.546 2.916A5.986 5.986 0 0010 16a5.986 5.986 0 004.546-2.084A5 5 0 0010 11z" clip-rule="evenodd" />
                                                </svg>
                                            </div>
                                            <span class="font-medium">{{ __('roles.' . $role->name) ?? $role->name }}</span>
                                        </div>
                                        <span class="text-xs opacity-75">{{ $role->permissions->count() }} {{ __('messages.permissions') }}</span>
                                    </div>
                                @endforeach
                            </div>
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-sm">{{ __('messages.no_role_assigned') }}</p>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <!-- Permissions Card -->
                <div class="lg:col-span-2 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
                    <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                        <div class="flex items-center justify-between">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 flex items-center">
                                <svg class="w-5 h-5 {{ app()->getLocale() === 'ar' ? 'ml-2' : 'mr-2' }} text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="p-6">
                            ...
                            <div x-data="{ expanded: false }" class="space-y-4">
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    @foreach($permissions->take(8) as $index => $permission)
                                        <div class="flex items-center p-3 bg-gray-50 dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 transition-all duration-200 hover:shadow-sm">
                                            <div class="w-8 h-8 bg-green-100 dark:bg-green-900 rounded-lg flex items-center justify-center {{ app()->getLocale() === 'ar' ? 'ml-3' : 'mr-3' }}">
                                    ...
                                    <div class="text-center pt-4 border-t border-gray-200 dark:border-gray-700">
                                        <button type="button" @click="expanded = !expanded"
                                            ...
                                            <span x-show="!expanded" class="flex items-center">
                                                ...
                                                {{ __('messages.show_all_permissions') }} ({{ $permissions->count() - 8 }} {{ __('messages.more') }})
                                            </span>
                                            <span x-show="expanded" class="flex items-center">
                                                <svg class="w-4 h-4 {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        @else
                            <div class="text-center py-8">
                                ...
                                <p class="text-gray-500 dark:text-gray-400 text-sm">{{ __('messages.no_permissions_assigned') }}</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <div class="mt-6 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
                <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 flex items-center">
                        <svg class="w-5 h-5 {{ app()->getLocale() === 'ar' ? 'ml-2' : 'mr-2' }} text-indigo-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                        <!-- Account Status -->
                        <div class="text-center p-4 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                            <div class="w-12 h-12 mx-auto mb-3 rounded-full flex items-center justify-center {{ $user->is_active ? 'bg-green-100 dark:bg-green-900' : 'bg-red-100 dark:bg-red-900' }}">
                                <svg class="w-6 h-6 {{ $user->is_active ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    @if($user->is_active)
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    @else
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728L5.636 5.636m12.728 12.728L18.364 5.636M5.636 18.364l12.728-12.728" />
                            ...
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.account_status') }}</p>
                        ...
                        <div class="text-center p-4 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                            ...
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.joined') }}</p>
                            <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ $user->created_at->diffForHumans() }}</p>
                        </div>

                        <!-- Total Roles -->
                        <div class="text-center p-4 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                            <div class="w-12 h-12 mx-auto mb-3 rounded-full bg-purple-100 dark:bg-purple-900 flex items-center justify-center">
                                <svg class="w-6 h-6 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                                </svg>
                            </div>
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.total_roles') }}</p>
                        ...
                        <div class="text-center p-4 rounded-lg bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700">
                            ...
                            <p class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('messages.total_permissions') }}</p>
    ...
    <div id="actionModal" class="fixed z-50 inset-0 overflow-y-auto hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            window.confirmAction = function(action) {
                ...
                if (action === 'disable') {
                    modalIcon.className = 'mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-yellow-100 dark:bg-yellow-900 sm:mx-0 sm:h-10 sm:w-10';
                    modalIcon.innerHTML = `
                    ...
                    modalMessage.innerHTML = '{{ __("messages.disable_user_confirmation") }} "<span class="font-semibold text-gray-900 dark:text-gray-100">{{ $user->name }}</span>"?';
                    actionForm.action = '{{ route("admin.users.toggle-active", $user->id) }}';
                    confirmButton.className = 'w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-4 py-2 bg-yellow-600 text-base font-medium text-white hover:bg-yellow-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-yellow-500 dark:focus:ring-offset-gray-800 sm:ml-3 sm:w-auto sm:text-sm transition-colors duration-200';
                    confirmButton.textContent = '{{ __("messages.disable") }}';
                } else if (action === 'enable') {
                    modalIcon.className = 'mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-green-100 dark:bg-green-900 sm:mx-0 sm:h-10 sm:w-10';
                    modalIcon.innerHTML = `
                    ...
                    modalMessage.innerHTML = '{{ __("messages.enable_user_confirmation") }} "<span class="font-semibold text-gray-900 dark:text-gray-100">{{ $user->name }}</span>"?';
                    actionForm.action = '{{ route("admin.users.toggle-active", $user->id) }}';
                    confirmButton.className = 'w-full inline-flex justify-center rounded-lg border border-transparent shadow-sm px-4 py-2 bg-green-600 text-base font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 dark:focus:ring-offset-gray-800 sm:ml-3 sm:w-auto sm:text-sm transition-colors duration-200';
