            ...
            <div class="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm mt-2">
                        <span
                            class="inline-block px-3 py-1 rounded-full text-white text-xs
                        ...
                        <div class="mt-4" x-data="{ expanded: false }">
                            ...
                            <div class="flex flex-wrap gap-2 mt-2">
                                <template x-for="(perm, index) in {{ $permissions }}" :key="index">
                                    <span x-show="expanded || index < 6"
                                        class="bg-gray-100 text-gray-800 px-2 py-1 rounded text-xs" x-text="perm"></span>
                                </template>
                            </div>
