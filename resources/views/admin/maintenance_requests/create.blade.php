...
@section('content')
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="relative">
                            <div class="flex bg-gray-100 dark:bg-gray-700 rounded-lg p-1 relative">
                                ...
                                {{-- Toggle Background --}}
                                <div id="toggleIndicator" class="absolute top-1 bottom-1 w-1/2 bg-white dark:bg-gray-600 rounded-md shadow-sm transition-transform duration-200 ease-in-out transform translate-x-0"></div>
                        ...
                        <div class="relative">
                            ...
                            <label for="image" class="block w-full cursor-pointer">
                                <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-4 text-center hover:border-blue-400 dark:hover:border-blue-500 transition-all duration-200 active:scale-95">
                                    ...
                                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">PNG, JPG, GIF {{ __('messages.up_to_10mb') }}</p>
    ...
    <style>
        ...
        .select2-container--default .select2-selection--single {
            ...
            height: 48px !important; /* زيادة الارتفاع للموبايل */
            padding: 0 !important;
        ...
        .select2-container--default .select2-selection--single .select2-selection__rendered {
            ...
            line-height: 46px !important; /* تطابق مع الارتفاع الجديد */
            padding-left: 12px !important;
            padding-right: 40px !important; /* مساحة أكبر للسهم */
        }
        ...
        .select2-container--default .select2-results__option {
            padding: 12px 16px !important; /* حجم أكبر للموبايل */
            color: rgb(17 24 39) !important;
            line-height: 1.5 !important;
            min-height: 48px !important; /* أهداف لمس أكبر */
        ...
        @media (max-width: 640px) {
            .select2-dropdown {
                width: 100% !important;
                max-height: 300px !important; /* ارتفاع أكبر للموبايل */
            ...
            $('.select2-unit, .select2-building').on('select2:open', function() {
                setTimeout(function() {
                    if (window.innerWidth <= 640) {
                        $('.select2-search__field').attr('placeholder', '{{ app()->getLocale() == "ar" ? "اكتب للبحث..." : "Type to search..." }}');
                    }
                }, 100);
            });
        });
