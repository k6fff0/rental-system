                        ...
                        <div class="p-6 space-y-4">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="bg-gray-50 rounded-xl p-4">
                                    ...
                                    <div class="font-semibold text-gray-900">{{ $request->building->name ?? 'غير محدد' }}
                                    </div>
                                </div>
                                <div class="bg-gray-50 rounded-xl p-4">
                                    <div class="text-sm text-gray-600 mb-1">رقم الوحدة</div>
                                    <div class="font-semibold text-gray-900">{{ $request->unit->unit_number ?? 'غير محدد' }}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="bg-orange-50 rounded-xl p-4">
                                    ...
                                    <div class="font-semibold text-orange-900">
                                        {{ $request->subSpecialty->name ?? 'غير محدد' }}</div>
                                </div>
                                <div class="bg-orange-50 rounded-xl p-4">
                                    <div class="text-sm text-orange-600 mb-1">التخصص الرئيسي</div>
                                    <div class="font-semibold text-orange-900">
                                        {{ $request->subSpecialty->parent->name ?? 'غير محدد' }}</div>
                                </div>
                            </div>
                                    ...
                                    @if ($request->image)
                                        <div class="space-y-3">
                                            ...
                                            <div class="relative group">
                                                <img src="{{ asset('storage/' . $request->image) }}" alt="صورة البلاغ"
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden">
                        ...
                        <div class="p-6 space-y-4">
                            <div class="text-center">
                                <div
                                    class="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mx-auto mb-3">
                            ...
                            <div class="bg-indigo-50 rounded-xl p-3 text-center">
                                ...
                                <span
                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $request->assigned_manually ? 'bg-yellow-100 text-yellow-800' : 'bg-blue-100 text-blue-800' }}">
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-xs text-gray-600 mt-1">
                                                {{ $request->created_at->format('Y/m/d H:i') }}</div>
                                            <div class="text-xs text-gray-500">بواسطة:
                                                {{ $request->creator->name ?? 'غير محدد' }}</div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($request->in_progress_at)
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-xs text-gray-500">بواسطة:
                                                {{ $request->inProgressBy->name ?? 'غير محدد' }}</div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($request->completed_at)
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-xs text-gray-500">بواسطة:
                                                {{ $request->completedBy->name ?? 'غير محدد' }}</div>
                                        </div>
                                    </div>
                                @endif
                                ...
                                @if ($request->rejected_at)
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div class="text-xs text-gray-500">بواسطة:
                                                {{ $request->rejectedBy->name ?? 'غير محدد' }}</div>
                                        </div>
                                    </div>
                                @endif
                            </div>
