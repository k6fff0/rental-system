 ...
 @section('content')
     <div class="min-h-screen bg-gray-50 dark:bg-gray-900 transition-colors duration-300"
         ...
         <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
             ...
             <!-- Header Section -->
             <div
                 class="bg-white dark:bg-gray-800 rounded-2xl shadow-xl mb-6 sm:mb-8 overflow-hidden transition-colors duration-300">
                 <div
                     class="bg-gradient-to-r from-blue-600 to-indigo-700 dark:from-blue-700 dark:to-indigo-800 px-4 sm:px-6 py-6 sm:py-8">
                     <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                         <div class="flex-1">
                             ...
                             <div class="flex flex-wrap items-center gap-2 sm:gap-3">
                                 <span
                                     class="inline-flex items-center bg-white/20 backdrop-blur-sm px-3 py-1.5 rounded-full text-sm font-medium text-white">
                                     <svg class="w-4 h-4 {{ app()->getLocale() === 'ar' ? 'ml-1.5' : 'mr-1.5' }}"
                                 ...
                                 @endphp
                                 <span
                                     class="inline-flex items-center {{ $statusColor }} backdrop-blur-sm px-3 py-1.5 rounded-full text-sm font-medium">
                                     <div
                                         class="w-2 h-2 rounded-full bg-current {{ app()->getLocale() === 'ar' ? 'ml-1.5' : 'mr-1.5' }} animate-pulse">
                                     </div>
                         ...
                         <div class="hidden lg:block">
                             <div
                                 class="w-16 h-16 sm:w-20 sm:h-20 bg-white/10 rounded-full flex items-center justify-center backdrop-blur-sm">
                                 <svg class="w-8 h-8 sm:w-10 sm:h-10 text-white/60" fill="none" stroke="currentColor"
                                     viewBox="0 0 24 24">
                                     <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
             ...
             <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
                 ...
                 <div class="xl:col-span-2 space-y-6 lg:space-y-8">
                     ...
                     <div
                         ...
                         <div
                             class="bg-gradient-to-r from-green-500 to-emerald-600 dark:from-green-600 dark:to-emerald-700 px-4 sm:px-6 py-4">
                             <h2 class="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                                 <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 20 20">
                                     <path
                                         d="M10.707 2.293a1 1 0 00-1.414 0l-9 9a1 1 0 001.414 1.414L2 12.414V15a1 1 0 001 1h3a1 1 0 001-1v-3a1 1 0 011-1h2a1 1 0 011 1v3a1 1 0 001 1h3a1 1 0 001-1v-2.586l.293.293a1 1 0 001.414-1.414l-9-9z" />
                                 </svg>
                         ...
                         <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                             <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                 <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 transition-colors duration-300">
                                     <div class="text-sm text-gray-600 dark:text-gray-400 mb-1 flex items-center">
                                         <svg class="w-4 h-4 {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }} text-green-500"
                                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                 ...
                                 <div class="bg-gray-50 dark:bg-gray-900 rounded-xl p-4 transition-colors duration-300">
                                     <div class="text-sm text-gray-600 dark:text-gray-400 mb-1 flex items-center">
                                         <svg class="w-4 h-4 {{ app()->getLocale() === 'ar' ? 'ml-1' : 'mr-1' }} text-blue-500"
                                             fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                             <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                 d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a1.994 1.994 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                         </svg>
                             ...
                             <div class="border-t border-gray-200 dark:border-gray-700 pt-4 sm:pt-6">
                                 ...
                                 <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                     <div
                                         class="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 transition-colors duration-300">
                                         ...
                                         <div class="font-semibold text-blue-900 dark:text-blue-100 direction-ltr">
                                             @if ($tenant?->phone)
                                                 <a href="tel:{{ $tenant->phone }}"
                                                     class="hover:underline">{{ $tenant->phone }}</a>
                                             @else
                                                 -
                                             @endif
                                         </div>
                                 ...
                                 @if ($request->extra_phone)
                                     <div
                                         class="mt-4 bg-green-50 dark:bg-green-900/20 rounded-xl p-4 transition-colors duration-300">
                                 ...
                                 @if ($request->audio_note)
                                     <div class="mt-6">
                                         ...
                                         <audio controls class="mt-2 w-full">
                                             <source src="{{ asset('storage/' . $request->audio_note) }}"
                                                 type="audio/webm">
                     ...
                     <div
                         class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
                         <div
                             class="bg-gradient-to-r from-orange-500 to-red-600 dark:from-orange-600 dark:to-red-700 px-4 sm:px-6 py-4">
                             <h2 class="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                                 <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 20 20">
                         ...
                         <div class="p-4 sm:p-6 space-y-4 sm:space-y-6">
                             <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                 <div
                                     class="bg-orange-50 dark:bg-orange-900/20 rounded-xl p-4 transition-colors duration-300">
                             ...
                             @if ($request->status === 'rejected' && $request->rejection_note)
                                 <div
                                     class="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-4 transition-colors duration-300">
                             ...
                             @if ($request->status === 'delayed' && $request->note)
                                 <div
                                     class="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-xl p-4 transition-colors duration-300">
                                     <div class="flex items-start gap-3">
                     ...
                     @if ($request->image || $request->completed_image)
                         <div
                             class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
                             <div
                                 class="bg-gradient-to-r from-purple-500 to-pink-600 dark:from-purple-600 dark:to-pink-700 px-4 sm:px-6 py-4">
                                 <h2 class="text-lg sm:text-xl font-bold text-white flex items-center gap-2">
                                     <svg class="w-5 h-5 sm:w-6 sm:h-6" fill="currentColor" viewBox="0 0 20 20">
                                         <path fill-rule="evenodd"
                                                     ...
                                                     <div
                                                         ...
                                                         <div class="absolute bottom-4 left-4 right-4">
                                                             <div class="flex items-center justify-between text-white">
                                                                 <span
                                                                     class="text-sm font-medium">{{ __('messages.click_to_enlarge') }}</span>
                 ...
                 <div class="space-y-6 lg:space-y-8">
                     ...
                     <div
                         class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
                         <div
                             class="bg-gradient-to-r from-indigo-500 to-blue-600 dark:from-indigo-600 dark:to-blue-700 px-4 sm:px-6 py-4">
                         ...
                         <div class="p-4 sm:p-6 space-y-4">
                             <div class="text-center">
                                 <div
                                     class="w-16 h-16 bg-indigo-100 dark:bg-indigo-900 rounded-full flex items-center justify-center mx-auto mb-3">
                                     ...
                                     @else
                                         <svg class="w-8 h-8 text-indigo-600 dark:text-indigo-400" fill="currentColor"
                                             viewBox="0 0 20 20">
                                             <path fill-rule="evenodd"
                             ...
                             <div
                                 class="bg-indigo-50 dark:bg-indigo-900/20 rounded-xl p-3 text-center transition-colors duration-300">
                                 <div
                                     class="text-xs text-indigo-600 dark:text-indigo-400 mb-1 flex items-center justify-center gap-1">
                                 ...
                                 <span
                                     class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $request->assigned_manually ? 'bg-yellow-100 dark:bg-yellow-900 text-yellow-800 dark:text-yellow-200' : 'bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-200' }}">
                     ...
                     <div
                         class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-300">
                         <div
                             class="bg-gradient-to-r from-gray-500 to-gray-600 dark:from-gray-600 dark:to-gray-700 px-4 sm:px-6 py-4">
                             <h2 class="text-lg font-bold text-white flex items-center gap-2">
                                 <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                     <path fill-rule="evenodd"
                             ...
                             <div class="space-y-4">
                                 ...
                                 @if ($request->created_at)
                                     <div class="flex items-start gap-3 relative">
                                         <div
                                             class="w-8 h-8 bg-blue-100 dark:bg-blue-900 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 relative z-10">
                                         ...
                                         <div class="flex-1 min-w-0 pb-4">
                                             <div class="font-semibold text-gray-900 dark:text-gray-100 text-sm">
                                                 {{ __('messages.request_created') }}</div>
                                             <div class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                                                 {{ $request->created_at->format('Y/m/d H:i') }}
                                             </div>
                                             <div class="text-xs text-gray-500 dark:text-gray-500">
                                                 {{ __('messages.by') }}:
                                                 {{ $request->creator->name ?? __('messages.not_specified') }}
                                             </div>
                                         </div>
                                 ...
                                 @if ($request->in_progress_at)
                                     <div class="flex items-start gap-3 relative">
                                         <div
                                             class="w-8 h-8 bg-yellow-100 dark:bg-yellow-900 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 relative z-10">
                                         ...
                                         <div class="flex-1 min-w-0 pb-4">
                                             <div class="font-semibold text-gray-900 dark:text-gray-100 text-sm">
                                                 {{ __('messages.work_started') }}</div>
                                             <div class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                                                 {{ \Carbon\Carbon::parse($request->in_progress_at)->format('Y/m/d H:i') }}
                                             </div>
                                             <div class="text-xs text-gray-500 dark:text-gray-500">
                                                 {{ __('messages.by') }}:
                                                 {{ $request->inProgressBy->name ?? __('messages.not_specified') }}
                                             </div>
                                         </div>
                                         <div class="absolute left-4 top-8 bottom-0 w-0.5 bg-gray-200 dark:bg-gray-700">
                                         </div>
                                 ...
                                 @if ($request->delayed_at)
                                     <div class="flex items-start gap-3 relative">
                                         <div
                                             class="w-8 h-8 bg-orange-100 dark:bg-orange-900 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 relative z-10">
                                         ...
                                         <div class="flex-1 min-w-0 pb-4">
                                             <div class="font-semibold text-gray-900 dark:text-gray-100 text-sm">
                                                 {{ __('messages.work_delayed') }}</div>
                                             <div class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                                                 {{ \Carbon\Carbon::parse($request->delayed_at)->format('Y/m/d H:i') }}
                                             </div>
                                             <div class="text-xs text-gray-500 dark:text-gray-500">
                                                 {{ __('messages.by') }}:
                                                 {{ $request->delayedBy->name ?? __('messages.not_specified') }}
                                             </div>
                                         </div>
                                         <div class="absolute left-4 top-8 bottom-0 w-0.5 bg-gray-200 dark:bg-gray-700">
                                         </div>
                                 ...
                                 @if ($request->completed_at)
                                     <div class="flex items-start gap-3 relative">
                                         <div
                                             class="w-8 h-8 bg-green-100 dark:bg-green-900 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 relative z-10">
                                         ...
                                         <div class="flex-1 min-w-0 pb-4">
                                             <div class="font-semibold text-gray-900 dark:text-gray-100 text-sm">
                                                 {{ __('messages.work_completed') }}</div>
                                             <div class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                                                 {{ \Carbon\Carbon::parse($request->completed_at)->format('Y/m/d H:i') }}
                                             </div>
                                             <div class="text-xs text-gray-500 dark:text-gray-500">
                                                 {{ __('messages.by') }}:
                                                 {{ $request->completedBy->name ?? __('messages.not_specified') }}
                                             </div>
                                         </div>
                                         <div class="absolute left-4 top-8 bottom-0 w-0.5 bg-gray-200 dark:bg-gray-700">
                                         </div>
                                 ...
                                 @if ($request->rejected_at)
                                     <div class="flex items-start gap-3 relative">
                                         <div
                                             class="w-8 h-8 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5 relative z-10">
                                         ...
                                         <div class="flex-1 min-w-0">
                                             <div class="font-semibold text-gray-900 dark:text-gray-100 text-sm">
                                                 {{ __('messages.request_rejected') }}</div>
                                             <div class="text-xs text-gray-600 dark:text-gray-400 mt-1">
                                                 {{ \Carbon\Carbon::parse($request->rejected_at)->format('Y/m/d H:i') }}
                                             </div>
                                             <div class="text-xs text-gray-500 dark:text-gray-500">
                                                 {{ __('messages.by') }}:
                                                 {{ $request->rejectedBy->name ?? __('messages.not_specified') }}
                                             </div>
                                         </div>
                                     </div>
                                 @endif
             ...
             images.forEach(img => {
                 img.addEventListener('error', function() {
                     ...
                     placeholder.className =
                         'w-full h-48 sm:h-56 lg:h-64 bg-gray-200 dark:bg-gray-700 rounded-xl flex items-center justify-center';
