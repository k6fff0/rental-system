            ...
            <form action="{{ route('admin.buildings.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="building_number" id="building_number" class="form-input w-full"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="owner_id_number" id="owner_id_number" class="form-input w-full"
                            required>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="rent_amount" id="rent_amount" class="form-input w-full" step="0.01"
                            required>
                    </div>
