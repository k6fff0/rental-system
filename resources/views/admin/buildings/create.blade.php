                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div class="lg:col-span-2 space-y-2">
                                ...
                                <div class="relative">
                                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                                        ...
                                        placeholder="أدخل اسم المبنى" required>
                                    <div
                            ...
                            <div class="space-y-2">
                                <label for="building_number"
                                    class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                                    <svg class="w-4 h-4 mr-2 rtl:ml-2 text-indigo-500" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <div class="lg:col-span-3 space-y-2">
                                ...
                                <div class="relative">
                                    <textarea name="address" id="address" rows="3"
                                        ...
                                        placeholder="أدخل العنوان الكامل للمبنى" required>{{ old('address') }}</textarea>
                            ...
                            <div class="space-y-2">
                                <label for="contract_start_date"
                                    ...
                                    <svg class="w-4 h-4 mr-2 rtl:ml-2 text-teal-500" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M8 7V3m8 4V3m-9 8h10m-12 5h14m-4 4v2m-6-2v2" />
                                    </svg>
                                    {{ __('messages.contract_start_date') }}
                                </label>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="space-y-2">
                                    <label for="rent_amount"
                                        ...
                                        {{ __('messages.rent_amount') }} {{ __('messages.currency') }}
                                    </label>
                                    <div class="relative">
                                        <input type="number" name="rent_amount" id="rent_amount"
                                            value="{{ old('rent_amount') }}" step="0.01" min="0"
                                ...
                                {{-- التعديل الأولي --}}
                                <div class="space-y-2">
                                    <label for="initial_renovation_cost"
                                        class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                                        <svg class="w-4 h-4 mr-2 rtl:ml-2 text-orange-500" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        {{ __('messages.initial_renovation_cost') }} {{ __('messages.currency') }}
                                    </label>
                                    <div class="relative">
                                        <input type="number" name="initial_renovation_cost" id="initial_renovation_cost"
                                            value="{{ old('initial_renovation_cost') }}" step="0.01" min="0"
                                            class="w-full px-4 py-3 pl-12 rtl:pr-12 rtl:pl-4 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors duration-200"
                                            placeholder="0.00">
                                        <div
                                            class="absolute inset-y-0 left-3 rtl:right-3 rtl:left-auto flex items-center pointer-events-none">
                                ...
                                {{-- شيك الضمان --}}
                                <div class="space-y-2">
                                    <label for="guarantee_cheque_amount"
                                        class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                                        <svg class="w-4 h-4 mr-2 rtl:ml-2 text-orange-500" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        ...
                                        {{ __('messages.guarantee_cheque_amount') }} {{ __('messages.currency') }}
                                    </label>
                                    <div class="relative">
                                        <input type="number" name="guarantee_cheque_amount" id="guarantee_cheque_amount"
                                            value="{{ old('guarantee_cheque_amount') }}" step="0.01" min="0"
                                            class="w-full px-4 py-3 pl-12 rtl:pr-12 rtl:pl-4 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors duration-200"
                                            placeholder="0.00">
                                        <div
                                            class="absolute inset-y-0 left-3 rtl:right-3 rtl:left-auto flex items-center pointer-events-none">
                                ...
                                <div class="space-y-2">
                                    <label for="grace_period_months"
                                        ...
                                        {{ __('messages.grace_period_months') }} ({{ __('messages.months') }})
                                    </label>
                                    <input type="number" name="grace_period_months" id="grace_period_months"
                                        value="{{ old('grace_period_months') }}" min="0"
                                        class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors duration-200"
                                        placeholder="مثلاً: 3">
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div class="flex items-center justify-center w-full">
                                    <label for="image"
                                        class="flex flex-col items-center justify-center w-full h-40 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-2xl cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200 group">
                                        <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                            <svg class="w-10 h-10 mb-4 text-gray-500 dark:text-gray-400 group-hover:text-teal-500 transition-colors"
                                            ...
                                            <p class="text-xs text-gray-500 dark:text-gray-400">PNG, JPG, JPEG (أقصى حجم:
                                                2MB)</p>
                                        </div>
                                ...
                                <div id="imagePreview" class="hidden">
                                    <div class="relative w-32 h-32 mx-auto">
                                        <img id="previewImg" src="" alt="معاينة الصورة"
                                            class="w-32 h-32 object-cover rounded-xl shadow-lg border-2 border-teal-500">
                                        <button type="button" onclick="removeImage()"
                                            class="absolute -top-2 -right-2 bg-red-500 hover:bg-red-600 text-white w-6 h-6 rounded-full flex items-center justify-center text-xs transition-colors">
    ...
    <script>
        ...
        document.getElementById('owner_phone').addEventListener('input', function(e) {
            ...
            if (value.startsWith('971')) {
                value = '+' + value;
            } else if (value.startsWith('05') || value.startsWith('50') || value.startsWith('52') || value
                .startsWith('54') || value.startsWith('55') || value.startsWith('56') || value.startsWith('58')) {
                value = '+971' + value;
            }
