                                ...
                                @php
                                    $generalInfo = [
                                        ...
                                        [
                                            ...
                                            'value' => $building->contract_start_date?->format('Y-m-d'),
                                            'icon' =>
                                                'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
                                        ],
                                        [
                                            'key' => 'contract_end_date',
                                            'value' => $building->contract_end_date?->format('Y-m-d'),
                                            'icon' =>
                                                'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
                                        ],
                                    ];
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                @php
                                    $financialInfo = [
                                        ...
                                        [
                                            'key' => 'guarantee_cheque_amount',
                                            'value' => $building->guarantee_cheque_amount
                                                ? number_format($building->guarantee_cheque_amount, 2) .
                                                    ' ' .
                                                    __('messages.aed')
                                                : null,
                                            'icon' =>
                                        ...
                                        [
                                            ...
                                            'value' => $building->grace_period_months
                                                ? $building->grace_period_months . ' ' . __('messages.months')
                                                : null,
                                            'icon' =>
                                                'M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z',
                                        ],
