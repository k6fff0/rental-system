        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
            ...
            <div class="xl:col-span-2">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                    ...
                    <form action="{{ route('admin.buildings.update', $building->id) }}" method="POST" enctype="multipart/form-data" class="p-6">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            @php
                                $basicFields = [
                                    ['name' => 'name', 'label' => 'اسم المبنى', 'type' => 'text', 'required' => true, 'icon' => 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4'],
                                    ['name' => 'building_number', 'label' => 'رقم المبنى', 'type' => 'text', 'required' => false, 'icon' => 'M7 20l4-16m2 16l4-16M6 9h14M4 15h14'],
                                    ['name' => 'address', 'label' => 'العنوان', 'type' => 'text', 'required' => true, 'icon' => 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z'],
                                    ['name' => 'municipality_number', 'label' => 'رقم تسجيل البلدية', 'type' => 'text', 'required' => false, 'icon' => 'M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z'],
                                ];
                            @endphp
                            
                            @foreach($basicFields as $field)
                                <div class="space-y-2">
                                    <label for="{{ $field['name'] }}" class="flex items-center text-sm font-medium text-gray-700 dark:text-gray-300">
                                    ...
                                    <div class="relative">
                                        <input type="{{ $field['type'] }}" 
                                               ...
                                               class="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors duration-200 {{ $errors->has($field['name']) ? 'border-red-500 ring-red-500' : '' }}"
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-600">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center">
                                <svg class="w-5 h-5 mr-2 rtl:ml-2 text-purple-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                @php
                                    $ownerFields = [
                                        ['name' => 'owner_name', 'label' => 'اسم المالك', 'type' => 'text', 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z'],
                                        ['name' => 'owner_nationality', 'label' => 'الجنسية', 'type' => 'text', 'icon' => 'M3 21v-4m0 0V5a2 2 0 012-2h6.5l1 1H21l-3 6 3 6h-8.5l-1-1H5a2 2 0 00-2 2zm9-13.5V9'],
                                        ['name' => 'owner_id_number', 'label' => 'رقم الهوية', 'type' => 'text', 'icon' => 'M10 6H5a2 2 0 00-2 2v9a2 2 0 002 2h14a2 2 0 002-2V8a2 2 0 00-2-2h-5m-4 0V5a2 2 0 114 0v1m-4 0a2 2 0 104 0m-5 8a2 2 0 100-4 2 2 0 000 4zm0 0c1.306 0 2.417.835 2.83 2M9 14a3.001 3.001 0 00-2.83 2M15 11h3m-3 4h2'],
                                        ['name' => 'owner_phone', 'label' => 'رقم الموبايل', 'type' => 'tel', 'icon' => 'M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z'],
                                    ];
                                @endphp
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-600">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center">
                                <svg class="w-5 h-5 mr-2 rtl:ml-2 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                @php
                                    $financialFields = [
                                        ['name' => 'rent_amount', 'label' => 'سعر الإيجار (درهم)', 'type' => 'number', 'step' => '0.01'],
                                        ['name' => 'initial_renovation_cost', 'label' => 'تكاليف التعديل الأولي (درهم)', 'type' => 'number', 'step' => '0.01'],
                                    ];
                                @endphp
                                ...
                                @foreach($financialFields as $field)
                                    <div class="space-y-2">
                                        ...
                                        <div class="relative">
                                            ...
                                            <div class="absolute inset-y-0 left-3 rtl:right-3 rtl:left-auto flex items-center pointer-events-none">
                                                <span class="text-orange-500 font-medium">AED</span>
                                            </div>
                                        </div>
                                        @error($field['name'])
                                            <p class="text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                        ...
                        <div class="mt-8 pt-8 border-t border-gray-200 dark:border-gray-600">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-6 flex items-center">
                                <svg class="w-5 h-5 mr-2 rtl:ml-2 text-teal-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-center w-full">
                                    <label for="image" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-xl cursor-pointer bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors duration-200">
                        ...
                        <div class="p-6">
                            <div class="relative group">
                                ...
                                <div class="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition-all duration-300 rounded-xl flex items-center justify-center">
                                    <div class="opacity-0 group-hover:opacity-100 flex space-x-3 rtl:space-x-reverse transition-all duration-300">
                                        ...
                                        <form action="{{ route('admin.buildings.deleteImage', $building->id) }}" method="POST" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
                            ...
                            <div class="space-y-4">
                                <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200 dark:border-gray-600">
                                    ...
                                    <button type="submit" 
                                        ...
                                        <span class="inline-block h-4 w-4 transform rounded-full bg-white transition {{ $building->families_only ? 'translate-x-6 rtl:-translate-x-6' : 'translate-x-1 rtl:-translate-x-1' }}"></span>
                                    </button>
                                </div>
...
let autoSaveTimeout;
const inputs = document.querySelectorAll('input[type="text"], input[type="number"], input[type="tel"], input[type="url"]');
