    ...
    <div class="flex justify-between items-center mb-8">
        <h1 class="text-3xl font-bold text-gray-800 flex items-center gap-2">
            <svg class="w-6 h-6 text-green-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h2l1 2h13l1-2h2m-6 2v4m-4-4v4m-4-4v4m8-10V4a1 1 0 00-1-1H7a1 1 0 00-1 1v4" />
            </svg>
            تعديل بيانات المبنى
        </h1>
    ...
    <div class="bg-white p-8 rounded-xl shadow space-y-8 border border-gray-100">
        ...
        <form action="{{ route('admin.buildings.update', $building->id) }}" method="POST">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {{-- رقم المبنى --}}
                <div>
                    <label for="building_number" class="block mb-1 text-sm font-semibold text-gray-700">رقم المبنى</label>
                ...
                {{-- رابط جوجل ماب --}}
                <div>
                    <label for="location_url" class="block mb-1 text-sm font-semibold text-gray-700">رابط Google Maps</label>
                ...
                {{-- الجنسية --}}
                <div>
                    <label for="owner_nationality" class="block mb-1 text-sm font-semibold text-gray-700">الجنسية</label>
                ...
                {{-- رقم الهوية --}}
                <div>
                    <label for="owner_id_number" class="block mb-1 text-sm font-semibold text-gray-700">رقم الهوية</label>
                ...
                {{-- رقم تسجيل البلدية --}}
                <div>
                    <label for="municipality_number" class="block mb-1 text-sm font-semibold text-gray-700">رقم تسجيل البلدية</label>
                ...
                {{-- سعر الإيجار --}}
                <div>
                    <label for="rent_amount" class="block mb-1 text-sm font-semibold text-gray-700">سعر الإيجار (شهريًا)</label>
                ...
                {{-- التعديل الأولي --}}
                <div>
                    <label for="initial_renovation_cost" class="block mb-1 text-sm font-semibold text-gray-700">تكاليف التعديل لأول مرة</label>
