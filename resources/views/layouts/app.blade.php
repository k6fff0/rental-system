...
<body class="font-sans antialiased bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-gray-100">
            ...
            <div class="flex items-center gap-3">
                ...
                @auth
                    ...
                    <div x-data='@json(['open' => false, 'hasNew' => $unreadNotificationsCount > 0])'>
                        ...
                        <div x-show="open"
                            class="absolute right-0 mt-2 w-44 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-[120]"
                            x-transition>
                    ...
                    <button @click="open = !open" type="button"
                        ...
                        <svg class="-mr-1 ml-2 h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                            ...
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M7 7l-3 3-3-3m0 6l3 3 3 3" />
                        </svg>
                    </button>

                    <div x-show="open"
                        class="absolute right-0 mt-2 w-28 rounded-md shadow-lg bg-white dark:bg-gray-700 ring-1 ring-black ring-opacity-5 z-[120]"
                        x-transition>
                        <div class="py-1 text-sm">
        ...
        <main class="py-6 relative z-30">
            @if (session('success'))
                <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 2000)"
                    ...
                    <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded shadow dark:bg-green-800 dark:border-green-600 dark:text-green-100"
                        role="alert">
    ...
    <div id="globalModal" x-data="{ show: false, html: '' }" x-cloak class="relative z-[9999]">
        <div x-show="show" class="fixed inset-0 bg-black bg-opacity-50 z-[9998] flex items-center justify-center"
            x-transition.opacity>
            <div @click.away="show = false"
                class="bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 max-w-3xl w-full mx-4 sm:mx-0 rounded-lg shadow-lg p-6 relative z-[9999] overflow-y-auto max-h-[90vh]"
                x-transition>
                <button @click="show = false" class="absolute top-2 right-2 text-gray-500 hover:text-red-500">
