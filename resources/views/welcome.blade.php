...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Tajawal:wght@400;500;700;900&family=Inter:wght@300;400;600;700&display=swap"
        rel="stylesheet">
...
<body class="bg-gray-50">
    ...
    <nav class="navbar glass-navbar fixed top-0 w-full z-50 py-4" id="mainNavbar">
        <div class="container mx-auto px-4 sm:px-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center space-x-3 space-x-reverse">
                    ...
                    <div class="relative">
                        <img src="{{ asset('storage/' . settings()->app_logo) }}" alt="Smart Step Logo"
                            class="w-16 h-16 rounded-xl object-cover shadow-lg animate-pulse-gentle">
                        <div class="absolute inset-0 rounded-xl bg-gradient-to-tr from-transparent to-white/20"></div>
                    </div>

                    <!-- اسم الشركة مع تأثير متدرج -->
                    <a href="#"
                        class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent">{{ __('messages.company_name') }}</a>
                </div>
                ...
                <div class="hidden md:flex items-center space-x-8 space-x-reverse">
                    <a href="{{ route('units.available') }}"
                        class="text-gray-700 hover:text-indigo-600 transition-all duration-300 font-medium relative group">
                        {{ __('messages.available_rooms') }}
                        <span
                            class="absolute bottom-0 left-0 w-0 h-0.5 bg-gradient-to-r from-indigo-600 to-cyan-500 group-hover:w-full transition-all duration-300"></span>
                    </a>
                    <a href="#about"
                        class="text-gray-700 hover:text-indigo-600 transition-all duration-300 font-medium relative group">
                ...
                <div class="flex items-center space-x-4 space-x-reverse">
                    <!-- تغيير اللغة -->
                    <select
                        onchange="window.location.href = '/lang/' + this.value + '?redirect={{ urlencode(request()->fullUrl()) }}'"
                    ...
                    <!-- زر تسجيل الدخول -->
                    <a href="{{ route('login') }}"
                        class="btn-primary text-white px-6 py-2.5 rounded-lg text-sm font-medium">
                        {{ __('messages.login') }}
                    </a>
                </div>
                ...
                <button
                    class="md:hidden text-gray-700 focus:outline-none p-2 rounded-lg hover:bg-gray-100 transition-colors"
                    id="mobileMenuButton">
        ...
        <div class="md:hidden hidden glass-card w-full py-4 px-4 mx-4 mt-4 rounded-xl" id="mobileMenu">
            <div class="flex flex-col space-y-3">
                ...
                <a href="#properties"
                    class="text-gray-700 hover:text-indigo-600 transition-colors py-3 px-4 rounded-lg hover:bg-white/50">{{ __('messages.nav_properties') }}</a>
                <a href="#contact"
                    class="text-gray-700 hover:text-indigo-600 transition-colors py-3 px-4 rounded-lg hover:bg-white/50">{{ __('messages.nav_contact') }}</a>
            </div>
        </div>
    </nav>
    ...
    <!-- قسم الهيرو المحسن -->
    <section id="home"
        class="relative h-screen flex items-center justify-center overflow-hidden gradient-animated hero-pattern">
        ...
        <div class="absolute top-20 left-10 w-20 h-20 bg-white/10 rounded-full animate-float"
            style="animation-delay: 0s;"></div>
        <div class="absolute top-40 right-20 w-16 h-16 bg-white/5 rounded-full animate-float"
            style="animation-delay: 2s;"></div>
        <div class="absolute bottom-40 left-20 w-24 h-24 bg-white/5 rounded-full animate-float"
        ...
        <div class="container mx-auto px-4 z-20 text-center text-white">
            <div class="glass-card p-8 rounded-2xl max-w-4xl mx-auto">
                <h1 class="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 animate-fadeInUp bg-gradient-to-r from-white to-cyan-200 bg-clip-text text-transparent"
                    style="animation-delay: 0.2s;">
                    {{ __('messages.hero_title') }}
                </h1>
                <p class="text-xl md:text-2xl lg:text-3xl mb-8 max-w-3xl mx-auto animate-fadeInUp text-gray-100"
                    style="animation-delay: 0.4s;">
                    {{ __('messages.hero_subtitle') }}
                </p>
                <div class="flex flex-col sm:flex-row gap-6 justify-center animate-fadeInUp"
                    style="animation-delay: 0.6s;">
                    <a href="#services"
                        class="btn-primary px-10 py-4 rounded-xl text-lg font-medium will-change-transform">
                        {{ __('messages.explore_services') }}
                    </a>
                    <a href="#contact"
                        class="btn-secondary px-10 py-4 rounded-xl text-lg font-medium will-change-transform">
        ...
        <div class="container mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-16 items-center">
                <div class="order-2 lg:order-1 animate-fadeInLeft">
                    <div
                        class="inline-block px-4 py-2 bg-gradient-to-r from-indigo-100 to-cyan-100 rounded-full text-indigo-600 font-semibold text-sm mb-6">
                        من نحن
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
                        <div class="counter-card p-6 rounded-2xl text-center group">
                            <div class="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent mb-3"
                                id="propertiesCounter">0</div>
                            <p class="text-gray-600 font-medium">{{ __('messages.about_properties') }}</p>
                        </div>
                        <div class="counter-card p-6 rounded-2xl text-center group">
                            <div class="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent mb-3"
                                id="yearsCounter">0</div>
                            <p class="text-gray-600 font-medium">{{ __('messages.about_experience') }}</p>
                        </div>
                        <div class="counter-card p-6 rounded-2xl text-center group">
                            <div class="text-4xl font-bold bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent mb-3"
                                id="clientsCounter">0</div>
                            <p class="text-gray-600 font-medium">{{ __('messages.about_clients') }}</p>
                        </div>
                    </div>

                    <a href="#contact"
                        class="btn-primary inline-block mt-10 px-8 py-4 rounded-xl font-medium">{{ __('messages.contact_us') }}</a>
                </div>
                ...
                <div class="order-1 lg:order-2 animate-fadeInRight">
                    <div class="relative rounded-3xl overflow-hidden shadow-2xl">
                        <img src="https://images.unsplash.com/photo-1560520031-3a4dc4e9de0c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1067&q=80"
                            alt="{{ __('messages.smart_step_team') }}" class="w-full h-auto lazy" loading="lazy">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="service-card rounded-2xl p-8 text-center group">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl flex items-center justify-center mb-6 mx-auto service-icon">
                ...
                <div class="service-card rounded-2xl p-8 text-center group">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl flex items-center justify-center mb-6 mx-auto service-icon">
                ...
                <div class="service-card rounded-2xl p-8 text-center group">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-purple-100 to-violet-100 rounded-2xl flex items-center justify-center mb-6 mx-auto service-icon">
                        <svg class="w-10 h-10 text-violet-600" width="40" height="40" viewBox="0 0 512 512"
                            fill="currentColor">
                            <path
                ...
                <div class="service-card rounded-2xl p-8 text-center group">
                    <div
                        class="w-20 h-20 bg-gradient-to-br from-orange-100 to-amber-100 rounded-2xl flex items-center justify-center mb-6 mx-auto service-icon">
    ...
    <section id="properties" class="py-20 bg-gradient-to-br from-white to-gray-50 reveal">
        <div class="container mx-auto px-4">
                ...
                <div class="property-card rounded-3xl overflow-hidden shadow-lg will-change-transform">
                    <div class="property-image relative h-64 md:h-72">
                        <img src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-4.0.3&auto=format&fit=crop&w=1170&q=80"
                            alt="{{ __('messages.room_1_title') }}" class="w-full h-full object-cover lazy"
                            loading="lazy">
                        <div
                            class="absolute top-4 right-4 bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex justify-between items-center">
                            <span
                                class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent">{{ __('messages.room_1_price') }}</span>
                            <a href="{{ route('units.available') }}"
                                class="btn-primary px-6 py-3 rounded-xl text-sm font-medium">{{ __('messages.more_details') }}</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="property-card rounded-3xl overflow-hidden shadow-lg will-change-transform">
                    <div class="property-image relative h-64 md:h-72">
                        <img src="https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?ixlib=rb-4.0.3&auto=format&fit=crop&w=1035&q=80"
                            alt="{{ __('messages.room_2_title') }}" class="w-full h-full object-cover lazy"
                            loading="lazy">
                        <div
                            class="absolute top-4 right-4 bg-gradient-to-r from-green-500 to-emerald-600 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                            {{ __('messages.new') }}
                        </div>
                    </div>
                    <div class="p-8">
                        ...
                        <div class="flex justify-between items-center">
                            <span
                                class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent">{{ __('messages.room_2_price') }}</span>
                            <a href="{{ route('units.available') }}"
                                class="btn-primary px-6 py-3 rounded-xl text-sm font-medium">{{ __('messages.more_details') }}</a>
                        </div>
                    </div>
                ...
                <div class="property-card rounded-3xl overflow-hidden shadow-lg will-change-transform">
                    <div class="property-image relative h-64 md:h-72">
                        <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1169&q=80"
                            alt="{{ __('messages.room_3_title') }}" class="w-full h-full object-cover lazy"
                            loading="lazy">
                        <div
                            class="absolute top-4 right-4 bg-gradient-to-r from-purple-500 to-violet-600 text-white px-4 py-2 rounded-full text-sm font-semibold shadow-lg">
                    ...
                    <div class="p-8">
                        ...
                        <div class="flex justify-between items-center">
                            <span
                                class="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent">{{ __('messages.room_3_price') }}</span>
                            <a href="{{ route('units.available') }}"
                                class="btn-primary px-6 py-3 rounded-xl text-sm font-medium">{{ __('messages.more_details') }}</a>
                        </div>
                    </div>
            ...
            <div class="text-center mt-16">
                <a href="{{ route('units.available') }}"
                    class="btn-primary inline-block px-10 py-4 rounded-xl text-lg font-medium">{{ __('messages.view_all_units') }}</a>
            </div>
        </div>
    </section>
    ...
    <section class="py-20 gradient-animated text-white reveal">
        <div class="container mx-auto px-4 text-center">
            <div class="glass-card p-12 rounded-3xl max-w-4xl mx-auto">
                ...
                <p class="text-xl md:text-2xl mb-10 max-w-3xl mx-auto text-gray-100">
                    {{ __('messages.cta_description') }}</p>
                <div class="flex flex-col sm:flex-row gap-6 justify-center">
                    <a href="#contact"
                        class="bg-white text-indigo-600 hover:bg-gray-100 px-10 py-4 rounded-xl font-medium transition-all will-change-transform">{{ __('messages.contact_now') }}</a>
        ...
        <div class="container mx-auto px-4">
            <div class="grid lg:grid-cols-2 gap-16">
                ...
                <div class="animate-fadeInLeft ">
                    ...
                    <h2 class="text-4xl md:text-5xl font-bold text-gray-800 mb-8">{{ __('messages.contact_title') }}
                    </h2>
                    ...
                    <form action="{{ route('complaints.store') }}" method="POST" class="contact-form space-y-6">
                        ...
                        <div>
                            <label
                                class="block text-gray-700 font-semibold mb-3 text-lg">{{ __('messages.full_name') }}</label>
                            <input type="text" name="name" required
                                class="w-full px-6 py-4 rounded-xl border-0 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                value="{{ old('name') }}">
                            @error('name')
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            <div>
                                <label
                                    class="block text-gray-700 font-semibold mb-3 text-lg">{{ __('messages.phone_number') }}</label>
                            ...
                            <div>
                                <label
                                    class="block text-gray-700 font-semibold mb-3 text-lg">{{ __('messages.email') }}</label>
                        ...
                        <div>
                            <label
                                class="block text-gray-700 font-semibold mb-3 text-lg">{{ __('messages.message') }}</label>
                            <textarea name="message" rows="6" required
                                class="w-full px-6 py-4 rounded-xl border-0 focus:outline-none focus:ring-2 focus:ring-indigo-500 resize-none">{{ old('message') }}</textarea>
                            @error('message')
                                <p class="text-red-500 text-sm mt-2">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="animate-fadeInRight">
                    <div class="glass-card rounded-3xl p-10 shadow-xl h-full">
                        <h3 class="text-3xl font-bold text-gray-800 mb-10">{{ __('messages.contact_info_title') }}
                        </h3>

                        <div class="space-y-8 ">
                            <div class="flex items-start space-x-6 space-x-reverse">
                                <div
                                    class="w-16 h-16 bg-gradient-to-br from-blue-100 to-indigo-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600 text-lg">عشارج ,مدينة العين، أبوظبي، الإمارات العربية
                                        المتحدة</p>
                                </div>
                            </div>
                            ...
                            <div class="flex items-start space-x-6 space-x-reverse">
                                <div
                                    class="w-16 h-16 bg-gradient-to-br from-green-100 to-emerald-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                            ...
                            <div class="flex items-start space-x-6 space-x-reverse">
                                <div
                                    class="w-16 h-16 bg-gradient-to-br from-purple-100 to-violet-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                                ...
                                <div>
                                    <h4 class="text-xl font-bold text-gray-800 mb-2">{{ __('messages.email_title') }}
                                    </h4>
                            ...
                            <div class="flex items-start space-x-6 space-x-reverse">
                                <div
                                    class="w-16 h-16 bg-gradient-to-br from-orange-100 to-amber-100 rounded-2xl flex items-center justify-center flex-shrink-0">
        ...
        <div class="container mx-auto px-4">
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                ...
                <div>
                    ...
                    <p class="text-gray-300 mb-6 text-lg leading-relaxed">شريكك الموثوق في العقارات والمقاولات في مدينة
                        العين</p>
                    <div class="flex space-x-4 space-x-reverse">
                        <a href="#"
                            class="w-12 h-12 bg-white/10 hover:bg-white/20 rounded-2xl flex items-center justify-center transition-all duration-300 group">
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        ...
                        <li><a href="#about"
                                class="text-gray-300 hover:text-white transition-colors duration-300 text-lg hover:translate-x-2 inline-block">{{ __('messages.nav_about') }}</a>
                        </li>
                        <li><a href="#services"
                                class="text-gray-300 hover:text-white transition-colors duration-300 text-lg hover:translate-x-2 inline-block">{{ __('messages.nav_services') }}</a>
                        </li>
                        <li><a href="#properties"
                                class="text-gray-300 hover:text-white transition-colors duration-300 text-lg hover:translate-x-2 inline-block">{{ __('messages.nav_properties') }}</a>
                        </li>
                        <li><a href="#contact"
                                class="text-gray-300 hover:text-white transition-colors duration-300 text-lg hover:translate-x-2 inline-block">{{ __('messages.nav_contact') }}</a>
                        </li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li><a href="#"
                                class="text-gray-300 hover:text-white transition-colors duration-300 text-lg hover:translate-x-2 inline-block">{{ __('messages.service_rent') }}</a>
                        </li>
                        <li><a href="#"
                ...
                <div>
                    ...
                    <form class="space-y-4">
                        <input type="email" placeholder="بريدك الإلكتروني"
                            class="w-full px-6 py-4 rounded-xl bg-white/10 border border-white/20 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-white/50 focus:bg-white/20 transition-all backdrop-blur-10">
                        <button
                            class="btn-primary w-full py-4 rounded-xl font-semibold">{{ __('messages.subscribe') }}</button>
                    </form>
                </div>
            </div>
    ...
    <script>
        ...
        function animateCounters() {
            const counters = [{
                    element: 'propertiesCounter',
                    target: 150,
                    duration: 2000,
                    suffix: '+'
                },
                {
                    element: 'yearsCounter',
                    target: 10,
                    duration: 1500,
                    suffix: '+'
                },
                {
                    element: 'clientsCounter',
                    target: 2500,
                    duration: 2500,
                    suffix: '+'
                }
