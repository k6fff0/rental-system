        ...
        <form method="POST" action="{{ route('profile.update') }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                ...
                <div class="space-y-5">
                    ...
                    <!-- Status -->
                    <div>
                        <label for="technician_status" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                            {{ __('messages.status') }}
                        </label>
                        <select id="technician_status" name="technician_status"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md shadow-sm 
                                       focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500
                                       dark:bg-gray-700 dark:text-white">
                            <option value="available" {{ auth()->user()->technician_status === 'available' ? 'selected' : '' }}>
                                {{ __('messages.available') }}
                            </option>
                            <option value="unavailable" {{ auth()->user()->technician_status === 'unavailable' ? 'selected' : '' }}>
