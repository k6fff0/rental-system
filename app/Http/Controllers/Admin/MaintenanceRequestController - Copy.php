...
{
    $requests = MaintenanceRequest::with(['building', 'unit', 'category'])
   ...
   public function create()
{
    ...
    return view('admin.maintenance_requests.create', compact('buildings', 'units', 'categories'));
}
    ...
    public function store(Request $request)
{
    ...
    $data = $request->only(['building_id', 'unit_id', 'category_id', 'description']);
