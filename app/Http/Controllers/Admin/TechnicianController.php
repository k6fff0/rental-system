   ...
   public function show($id)
{
    ...
    return view('admin.technicians.show', compact(
        'technician', 'requests', 'total', 'completed', 'rejected', 'new', 'in_progress',
        'averageDuration', 'fastest', 'slowest', 'totalCost', 'logs'
    ));
}
	...
	public function report(Request $request, $id)
{
    ...
    return view('admin.technicians.report', compact(
        'technician', 'requests', 'total', 'completed', 'new', 'rejected', 'inProgress',
        'averageDuration', 'fastest', 'slowest', 'totalCost', 'logs'
    ));
}
